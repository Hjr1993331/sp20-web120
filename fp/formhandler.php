...
$body ="Here is the message from the website from the body:\n";
...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc:hjroath@icloud.com' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Email from the website from the subject'; // if your client has more than one web site, you can put the site name here.
...
mail ('hjroath1993@gmail.com', $subject, $body, $from);

header('Location: thk.php'); // replace "thx.html" with the name and path to your actual thank you page
