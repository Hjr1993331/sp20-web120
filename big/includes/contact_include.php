...
$siteKey = "6LcXmu4UAAAAAB9ZHbs3m80etilkTabvHNmEconb";
$secretKey = "6LcXmu4UAAAAAPA6jFhjwNn6T9nESBf8ac8ccvf4";
date_default_timezone_set('America/Los_Angeles'); #sets default date/timezone for this website
$server = 'inmotionhosting.com';
//end config area ----------------------------------------
...
function loadContact($form,$feedback='')
{
    ...
    if($toAddress=='' || $toAddress == 'hjroath@icloud.com')
    {
